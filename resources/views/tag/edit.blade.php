    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700">
                <h2 class="text-xl font-bold mb-8 text-gray-900 dark:text-gray-100 border-b dark:border-gray-700 pb-3">
                    Edit Tag: {{ $tag->name }}</h2>

                <form action="{{ route('tag.update', $tag) }}" method="POST" class="space-y-6">
                    @csrf @method('PUT')
                    ...
                    <div class="flex items-center justify-end gap-4 pt-6 border-t dark:border-gray-700">
                        ...
                        <x-primary-button
                            class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-lg font-bold uppercase tracking-widest transition">Update
                            Tag</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
