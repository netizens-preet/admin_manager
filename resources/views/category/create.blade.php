                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="5"
                            class="block w-full border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm">{{ old('description') }}</textarea>
